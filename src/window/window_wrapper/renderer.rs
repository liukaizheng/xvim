...
impl SkiaRenderer {
    pub fn new(windowed_context: &WindowedContext) -> Self {
        ...
        let fb_info = {
            ...
            FramebufferInfo {
                fboid: fboid.try_into().expect("Could not crate frame buffer id"),
...
fn create_surface(
    ...
    let size = (
        ...
        size.height.try_into().expect("Could not convet height"),
    );
    ...
    .expect("Could not crate surface")
}
